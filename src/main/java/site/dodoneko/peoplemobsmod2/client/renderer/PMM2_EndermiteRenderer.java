...
public class PMM2_EndermiteRenderer<T extends MobEntity> extends PMM2_BipedRenderer<T, PMM2_BipedModel<T>>
{
    private static ResourceLocation ENTITY_TEXTURES = new ResourceLocation("textures/entity/endermite-chan.png");

    public PMM2_EndermiteRenderer(EntityRendererManager renderManager) {
