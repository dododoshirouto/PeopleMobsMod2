...
public class PMM2_BipedRenderer<T extends MobEntity, M extends PMM2_BipedModel<T>> extends MobRenderer<T, M> {
   ...
   public PMM2_BipedRenderer(EntityRendererManager renderManagerIn, M modelBipedIn, float shadowSize,
         boolean setLayers) {
   ...
   public PMM2_BipedRenderer(EntityRendererManager renderManagerIn, M modelBipedIn, M modelLeggings, M modelArmor,
         float shadowSize) {
   ...
   public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      model.entityMotion = new Vec3d(entity.posX - entity.prevPosX, entity.posY - entity.prevPosY,
